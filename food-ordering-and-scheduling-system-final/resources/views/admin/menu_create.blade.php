...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 pb-24">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 pb-6 border-b border-slate-100">
        <div>
            ...
            <p class="text-slate-500 font-bold mt-1">Populate the culinary selection with gourmet options, customized attributes, and high-fidelity presentation photos</p>
        </div>
        <div class="flex items-center gap-3 bg-white px-5 py-3 rounded-2xl border shadow-sm shrink-0 self-start md:self-auto">
            ...
            <p class="text-xs font-black uppercase tracking-wide text-slate-700">Awaiting Record Entry</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl border border-slate-100 overflow-hidden" x-data="{
        name: '',
        category: '{{ $categories->first()?->name ?? 'Meals' }}',
        price: '',
        description: '',
        imageType: 'url',
        imageUrl: '',
        ...
        <form action="{{ route('admin.menu.store') }}" method="POST" enctype="multipart/form-data" class="p-8 md:p-12">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div class="lg:col-span-7 space-y-10">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 font-bold mt-1">Detail the characteristics of the upcoming product carefully</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="name" x-model="name" required
                                ...
                                placeholder="e.g. Butter Roast Prime Rib">
                        </div>
                ...
                <div class="lg:col-span-5 flex flex-col justify-start">
                    <div class="sticky top-24 space-y-6 bg-slate-50/50 p-8 rounded-[3rem] border border-dashed border-slate-200">
                        <div>
                            <h3 class="text-xl font-black text-slate-900">Immediate Display</h3>
